namespace XWingPluginForCompass3D.Model
{
    ...
    public class BlastersConstants
    {
        ...
        /// <summary>
        /// Координата центра плоскости внутренней боковой стороны правого
        /// нижнего острия.
        /// </summary>
        public Point3D SideRightTipPlane { get; }

        /// <summary>
        /// Координата центра плоскости внутренней боковой стороны левого
        /// нижнего острия.
        /// </summary>
        public Point3D SideLeftTipPlane { get; }

        /// <summary>
        /// Координата плоскости передней грани основного тела оружия
        /// (правого верхнего).
        /// </summary>
        ...
        /// <summary>
        /// Массив точек, используемых для построения отрезков основания острия
        /// для правых нижнего и верхнего бластеров.
        ...
        /// <summary>
        /// Массив дуг, используемых для построения скругления основания острия
        /// для правых  нижнего и верхнего бластеров.
        /// В ходе программы координаты отразятся.
        /// </summary>
        ...
        /// <summary>
        /// Массив точек, используемых для построения отрезков антенны
        /// для правых нижнего и верхнего бластеров.
        /// </summary>
        public Point2D[,,] RightAntennaSegments { get; }

        /// <summary>
        /// Массив дуг, используемых для построения антенны для
        /// правых нижнего и верхнего бластеров.
        /// </summary>
        public Arc[,] RightAntennaArcs { get; }

        /// <summary>
        /// Массив точек, используемых для построения отрезков
        /// антенны для левых нижнего и верхнего бластеров.
        /// </summary>
        public Point2D[,,] LeftAntennaSegments { get; }

        /// <summary>
        /// Массив дуг, используемых для построения антенны для левых
        /// нижнего и верхнего бластеров.
        /// </summary>
        public Arc[,] LeftAntennaArcs { get; }

        /// <summary>
        /// Массив точек, используемых для построения отрезков рисунка для
        /// правых нижнего и верхнего бластеров.
        /// В ходе программы координаты отразятся.
        /// </summary>
        ...
        /// <summary>
        /// Массив кругов, используемых для построения отрезков рисунка для
        /// правых нижнего и верхнего бластеров.
        /// В ходе программы координаты отразятся.
        /// </summary>
