...
namespace XWingPluginForCompass3D.UnitTests
{
    ...
    public class TestAcceleratorsConstants
    {
        ...
        private readonly Dictionary<Point3DTypes, Func<Point3D>> _point3DDictionary
        ...
        private readonly Dictionary<Point2DTypes, Func<Point2D[,,]>> _point2DDictionary
        ...
        private readonly Dictionary<Point2DTypes, Point2D[,,]> _point2D
        ...
        [Test(Description = "Позитивный тест геттеров на возвращение" +
                            "точки 3D плоскости.")]
        [TestCase(98.760456, 54.834961, -600 - Difference,
            Point3DTypes.CurrentPlane)]
            ...
            Point3DTypes type)
        {
            var expected =
                new Point3D(x, y, z);
            var actual = _point3DDictionary[type]();
        ...
        {
            var expected = _point2D[type];
            var actual = _point2DDictionary[type]();
        ...
        public void TestAirIntakeCirclesGet_CorrectValue()
        {
            ...
            var actual = Constants.AirIntakeCircles;
        ...
        public void TestTurbineCirclesSet_CorrectValue()
        {
            ...
            var actual = Constants.TurbineCircles;
            Assert.IsTrue(_check.CheckEqual(excepted, actual));
        }
        ...
        public void TestAirIntakeBaseCuttingArcsGet_CorrectValue()
        {
            ...
            var actual = Constants.AirIntakeBaseCuttingArcs;
            Assert.IsTrue(_check.CheckEqual(excepted, actual));
        }
        ...
        public void TestAirIntakeBaseCuttingSegmentsGet_CorrectValue()
        {
            ...
            var actual = Constants.AirIntakeBaseCuttingSegments;
            Assert.IsTrue(_check.CheckEqual(excepted, actual));
        }
        ...
        public void TestAirIntakeLowerCuttingArcsGet_CorrectValue()
        {
            ...
            var actual = Constants.AirIntakeLowerCuttingArcs;
            Assert.IsTrue(_check.CheckEqual(excepted, actual));
        }
        ...
        public void TestAirIntakeMiddleCuttingArcsGet_CorrectValue()
        {
            ...
            var actual = Constants.AirIntakeMiddleCuttingArcs;
            Assert.IsTrue(_check.CheckEqual(excepted, actual));
        }
        ...
        public void TestAirIntakeMiddleCuttingSegmentsGet_CorrectValue()
        {
            ...
            var actual = Constants.AirIntakeMiddleCuttingSegments;
            Assert.IsTrue(_check.CheckEqual(excepted, actual));
        }
        ...
        public void TestAirIntakeSmallCuttingArcsGet_CorrectValue()
        {
            ...
            var actual = Constants.AirIntakeSmallCuttingArcs;
            Assert.IsTrue(_check.CheckEqual(excepted, actual));
        }
        ...
        public void TestAirIntakePartitionArcsGet_CorrectValue()
        {
            ...
            var actual = Constants.AirIntakePartitionArcs;
            Assert.IsTrue(_check.CheckEqual(excepted, actual));
        }
        ...
        public void TestNozzleDrawingCirclesGet_CorrectValue()
        {
            ...
            var actual = Constants.NozzleDrawingCircles;
            Assert.IsTrue(_check.CheckEqual(excepted, actual));
        }
    }
}